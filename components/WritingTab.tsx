  ...
  return (
    <div className="flex flex-col gap-4">
        ...
        {(["edit", "draft"] as Mode[]).map((m) => (
          <button
            ...
            className={`flex-1 py-1.5 rounded-md text-xs font-medium transition-colors capitalize ${
              mode === m ? "bg-violet-600 text-white" : "text-neutral-500 hover:text-neutral-700"
            }`}
          >
      ...
      <div className="flex items-center gap-2">
        ...
        <select
          className="flex-1 rounded-lg bg-neutral-100 border border-neutral-200 text-neutral-700 text-xs px-3 py-2 focus:outline-none focus:border-violet-500/50"
          value={tone}
      ...
      {mode === "edit" && (
        <>
          <textarea
            className="w-full rounded-lg bg-neutral-100 border border-neutral-200 text-neutral-800 text-xs p-3 resize-none focus:outline-none focus:border-violet-500/50 placeholder-neutral-400 min-h-[110px]"
