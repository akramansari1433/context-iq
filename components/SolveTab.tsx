...
export function SolveTab({ context, activeTabId }: Props) {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* Page being analyzed */}
      <div className="rounded-lg bg-neutral-100 border border-neutral-200 px-3 py-2 flex items-center gap-2">
        <span className="text-neutral-500 text-xs">Reading:</span>
        <span className="text-neutral-700 text-xs truncate">{pageTitle}</span>
      </div>
      ...
      <div className="flex flex-col gap-1">
        ...
        <textarea
          className="w-full rounded-lg bg-neutral-100 border border-neutral-200 text-neutral-800 text-xs p-3 resize-none focus:outline-none focus:border-violet-500/50 placeholder-neutral-400"
          style={{ minHeight: 70 }}
      ...
      {loading && (
        <div className="flex flex-col items-center gap-2 py-6">
          <div className="w-5 h-5 rounded-full border-2 border-neutral-300 border-t-violet-500 animate-spin" />
